  ...
  return (
    <>
      <section
        ...
        className="w-full h-auto py-12 md:py-24 lg:py-32 bg-cover bg-center bg-[url('/images/kinclRemake.jpg')] animate-glow"
      >
      ...
      >
        <div className="container mx-auto px-4 h-auto">
          ...
          <h2 className="text-5xl tracking-tighter text-center mb-14 mt-8 md:text-7xl xl:text-9xl">
            Naše služby
          </h2>
